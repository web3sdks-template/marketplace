...
**Check out the Demo here**: https://marketplace.web3sdks-template.com

## Tools

- [**web3sdks Marketplace**](https://docs.web3sdks.com/contracts/marketplace): to facilitate the listing of NFTs and enable users to make buy, sell, or make offers on the NFTs on the marketplace.
- [**web3sdks NFT Collection**](https://docs.web3sdks.com/contracts/nft-collection): to create an ERC721 NFT Collection that we can list onto the marketplace.
- [**web3sdks React SDK**](https://docs.web3sdks.com/react): to enable users to connect and disconnect their wallets with our website, and access hooks such as [useContract](https://docs.web3sdks.com/react/react.usecontract) and [useActiveListings](https://docs.web3sdks.com/react/react.useactivelistings) to interact with the marketplace.
- [**web3sdks TypeScript SDK**](https://docs.web3sdks.com/typescript): to connect to our marketplace smart contract, create new listings, make offers and buy listings!
...
```bash
npx web3sdks create --template marketplace
```

- Create your own Marketplace contract via the web3sdks dashboard. (Follow the steps in the guide below if you need extra help)!
...
- Head to the [web3sdks dashboard](https://web3sdks.com/dashboard).
- Click **Create a new contract**.
- Click **Setup Marketplace**.
- Configure & Deploy!

## The Web3sdks Provider

The web3sdks React provider makes it straightforward to let your users connect their wallets to your website, and it abstracts away all the boilerplate you would usually have to write.

Open `pages/_app.tsx` we wrap all of our pages in the `<Web3sdksProvider>` component.

```tsx
<Web3sdksProvider desiredChainId={ChainId.Goerli}>
  <Component {...pageProps} />
</Web3sdksProvider>
```
...
We connect user's wallets to our website by using the web3sdks React SDK's [useMetamask](https://docs.web3sdks.com/react/react.usemetamask) hook.
...
Then, we use the [useContract](https://docs.web3sdks.com/react/react.useContract) hook to connect to our smart contract via it's contract address.
...
If you don't have NFTs that you can list, [you can create an NFT Collection via our dashboard](https://web3sdks.com/dashboard).
